...
%%%
%%% Copyright (c) 2001-2004 Kungliga Tekniska H??olan
...
-define(MYSQL_ENCODING, ?GET_ENV_STR(mysql_encoding, utf8)).
-define(MYSQL_HOST,     ?GET_ENV_STR(mysql_host,     "localhost")).
-define(MYSQL_PORT,     ?GET_ENV_INT(mysql_port,     3306)).
-define(MYSQL_USERNAME, ?GET_ENV_STR(mysql_username, "root")).
-define(MYSQL_PASSWORD, ?GET_ENV_STR(mysql_password, "ybybyb")).
-define(MYSQL_DATABASE, ?GET_ENV_STR(mysql_database, "gamedb_tengyun")).
-define(MYSQL_POLLSIZE, ?GET_ENV_INT(mysql_poolsize, 1)).
...
start_link ()->
	start_link(gamedb, ?MYSQL_HOST, ?PORT, ?MYSQL_USERNAME, ?MYSQL_PASSWORD, ?MYSQL_DATABASE, undefined, ?MYSQL_ENCODING).
